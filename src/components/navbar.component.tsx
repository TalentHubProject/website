    ...
    return (<header>
        <nav className="inline-flex justify-between w-full items-center pb-8">
            ...
            <ul className="inline-flex items-center text-sm text-livid">
                ...
                <li className="mr-6">
                    <Link href="/contact" className="hover:text-white delay-75 duration-100 ease-in-out">Trombinoscope</Link>
                </li>
            </ul>
            <Link href="/login" className="inline-flex justify-between hover:text-white delay-75 duration-100 ease-in-out text-livid text-sm">
