...
export default function Navbar() {
    return (<nav className="w-full flex flex-row justify-between px-20 py-10">
            <a href="/">
            ...
            <div>
                <ul className="flex flex-row justify-between gap-10 font-semibold text-livid">
                    ...
                    <li><a className="transition-colors duration-200 hover:text-indigo-600" href="#">Trombinoscope</a>
                    </li>
                </ul>
            </div>
            <a href="#">
