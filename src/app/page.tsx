...
export default function Home() {
    return (<main className="flex justify-center text-center items-center px-auto flex-col gap-10">
        <section>
        ...
        <section>
            <Image src="/img.png" alt="Overview of the discord server" width={800} height={600}
                   className="-skew-x-12 hover:skew-x-0 transition-all duration-500 ease-in-out border"/>
        </section>
        <section>
