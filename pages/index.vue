  ...
  <div>
    <div class="min-h-screen flex justify-center align-middle">
      <section class="bg-white">
        ...
        >
          <h1
            class="mb-8 text-5xl font-extrabold tracking-tight leading-none md:mb-16 lg:text-6xl bg-clip-text text-transparent bg-gradient-to-t from-[#C14168] to-[#DF8F90]"
          >
          ...
          >
            <span class="font-semibold mb-8 text-gray-400 uppercase">
              <JoinButton text="Rejoindre l’aventure" />
            </span>
            <div
              class="flex flex-wrap justify-around sm:justify-center items-center mt-32 text-gray-500 sm:justify-around"
            >
              <a
                href="#"
                class="lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
              >
                <img class="" src="~/assets/images/DISCORD FRANCE.png" />
              </a>
              <a>
                <img class="" src="~/assets/images/lljs.png" />
              </a>
              <a>
                <img class="" src="~/assets/images/elkir.png" />
              </a>
              <a>
                <img class="" src="~/assets/images/ltdd.png" />
              </a>
            </div>
          </div>
        </div>
    ...
    <section class="mt-8 pb-8 md:mt-32">
      <div class="border-solid md:border-2 border-blue-500 m-3 rounded-xl">
        <div
          class="mt-2 md:16 pt-32 px-4 mx-auto max-w-screen-xl text-center lg:pt-16"
        >
          <div class="flex items-center justify-center">
            <div class="bg-slate-200 px-4 py-1 rounded text-slate-700">
              <img
                class="float-left pt-1 pr-2"
                src="~/assets/images/file.png"
              />
              A propos
            </div>
          </div>
          <h1 class="text-2xl md:text-3xl pt-12 font-bold">
            Qu'est-ce que Talent Hub ?
          </h1>
          <p
            class="text-lg pt-8 font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-64 dark:text-gray-400"
          >
            Découvrez Talent Hub, la plateforme collaborative ultime qui
            rassemble les esprits créatifs et innovants.
          </p>
          <div
            class="px-0 md:px-12 mt-20 md:pb-16 grid grid-cols-1 gap-16 md:grid-cols-3 md:gap-5 text-left"
          >
            <div>
    ...
    <section class="polygon w-full">
      <div
        class="mt-0 pt-48 md:pt-16 pb-32 px-4 mx-auto max-w-screen-xl text-center lg:pt-80"
      >
        <div class="flex items-center justify-center">
          <div class="Polos px-4 py-1 rounded">
            <img class="float-left pt-1 pr-2" src="~/assets/images/poles.png" />
            <p class="float-left">Pôles</p>
          </div>
        </div>
        <h1 class="text-2xl px-0 pt-6 font-bold mx-0 text-white md:px-64">
          Venez partager, échanger, évoluer dans vos domaines respectifs.
        </h1>
        <div
        ...
        >
          ...
          >
            ...
            <p class="ml-4 w-60 pb-4 font-normal text-sm">
              Tu es graphiste ou fan de ce domaine ? Tu es au bon endroit !
            </p>
          </div>
          <div
          ...
          >
            ...
            <p class="ml-4 w-60 pb-4 font-normal text-sm">
              Tu es musicien ou fan de ce domaine? Tu es au bon endroit !
            </p>
          </div>
          <div
            class="mx-8 md:mx-0 border border-white rounded-md text-white hover:text-black hover:bg-white"
          >
            ...
            <p class="ml-4 w-60 pb-4 font-normal text-sm">
              Tu es investisseur.se ou fan de ce domaine? Tu es au bon endroit !
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            <p class="ml-4 w-60 pb-4 font-normal text-sm">
              Tu es développeur.se ou fan de ce domaine? Tu es au bon endroit !
            </p>
          </div>
          <div
            class="mx-8 md:mx-0 border border-white rounded-md text-white hover:text-black hover:bg-white"
      ...
      <div
        ...
        style="
          background: linear-gradient(
            90deg,
            rgba(223, 143, 144, 1) 0%,
            rgba(187, 46, 89, 1) 100%
          );
        "
      >
        <div class="py-28">
          <h1
            class="text-2xl lg:text-3xl font-bold mx-0 lg:mx-12 text-white xl:px-72"
          >
            Les meilleurs créateurs sont chez Talent Hub !
          </h1>
          <button
            @mouseover="isMouseOver = true"
            @mouseout="isMouseOver = false"
            class="mt-12 bg-white text-[#E05880] text-sm font-medium hover:text-white py-2 px-4 hover:border-transparent rounded"
            :class="isMouseOver ? 'red-fill' : ''"
          >
            <p class="float-left">Rejoindre l’aventure</p>
            <svg
              width="24"
              height="21"
              viewBox="0 0 24 24"
...
.polygon {
  clip-path: polygon(0 28%, 100% 7%, 100% 79%, 0 100%);
  background: linear-gradient(
    90deg,
    rgba(193, 65, 104, 1) 13%,
    rgba(223, 143, 144, 1) 100%
  );
}

.Polos {
  background-color: rgb(241 245 249 / 39%);
  border: 1px solid #f1f5f94d;
}

@media screen and (max-width: 426px) {
  /* Apply your polygon shape to the element */
  .polygon {
    position: relative;
